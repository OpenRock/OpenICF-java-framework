...
set CP="%CONNECTOR_SERVER_HOME%\lib\framework\connector-framework-1.1.0.0.jar";"%CONNECTOR_SERVER_HOME%\lib\framework\connector-framework-internal-1.1.0.0.jar";"%CONNECTOR_SERVER_HOME%\lib\framework\groovy-all-1.8.3.jar";
